entityMeta = entityMeta or FindMetaTable("Entity")

-- Call the function to send the fonts to the server console
...
function DrawBlurAt(x, y, width, height, amount, passes, alpha)
	amount = amount or 5
