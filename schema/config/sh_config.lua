-- Shit I had to add or else impulse will freak
SCHEMA = SCHEMA or {}

-- Define the schema details
SCHEMA.name = "Half-Life 2: Roleplay"
SCHEMA.author = "Nate"
SCHEMA.description = "Half-Life 2: Roleplay"

-- Framework related
impulse.Config.SchemaName = "Half-Life 2: Roleplay"
impulse.Config.SchemaVersion = 0.45
impulse.Config.SchemaCredits = [[<font=Impulse-Elements23>Nate
vin
aLoneWitness</font>
...
DPotatoman - Metropsolice pack</font>]]

impulse.Config.MainColour = Color(241, 138, 21)
impulse.Config.InteractColour = Color(211, 55, 8)

impulse.Config.UserSlots = 100 -- any other slots will be donator slots
impulse.Config.HUDAggressiveness = 0.5
impulse.Config.HUDSmoothness = 0.9
...
impulse.Config.StaminaDrain = 0.5
...
impulse.Config.PropLimit = 30
impulse.Config.PropLimitDonator = 90
...
impulse.Config.TeamChangeTimeDonator = 60
...
impulse.Config.BrokenArmsHealTime = 600 -- time in seconds
impulse.Config.BrokenRibsHealTime = 900
impulse.Config.BrokenLegsChance = 40
impulse.Config.BrokenArmsChance = 10
impulse.Config.BrokenRibsChance = 25
impulse.Config.CriticalBleedingChance = 15

impulse.Config.PropPrice = 5
impulse.Config.PropPriceDonator = 2

impulse.Config.RPNameChangePrice = 150

impulse.Config.CosmeticGenderPrice = 600
impulse.Config.CosmeticModelSkinPrice = 450

impulse.Config.MaxLetters = 5
...
impulse.Config.CommunityURL = "https://hl2.land"
impulse.Config.PanelURL = "https://hl2.land/home"
impulse.Config.DonateURL = "https://hl2.land/shop/e4a04b3e-dc24-44fe-bc9f-c6b0b41f6b09"
impulse.Config.DiscordURL = "https://discordapp.com/invite/jdzDuhaXac"
impulse.Config.SupportURL = "https://hl2.land" -- this can just be the forum url
