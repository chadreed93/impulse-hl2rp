...
ITEM.UniqueID = "rationcard_100"

ITEM.Name = "Citizen Credit"

ITEM.Desc =  "A standard card redeemable at any ATM for credits."
...
function ITEM:OnUse(ply, ent)
    ...
    if IsValid(traceent) and traceent:GetClass("impulse_atm") then
        ply:Notify("You have recieved 100 credits.")
        ply:GiveBankMoney(100)
        return true
    else
