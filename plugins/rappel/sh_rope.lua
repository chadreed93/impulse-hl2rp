...
if SERVER then
	function meta:IsRappelling()
		return self.Rappel
	end
	function meta:GetRappelAnchor()
		return self.Rappel.Anchor
	end
else
	function meta:IsRappelling()
		return self:GetSyncVar(SYNC_RAPPELLING, false)
	end
	function meta:GetRappelAnchor()
		return self:GetSyncVar(SYNC_RAPPEL_ANCHOR, Vector())
	end
end
